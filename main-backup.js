...
const translations = {
  en: {
    ...
    why_card2_desc: "With Hide All, you can run multiple accounts of hide apps for almost any app at the same time, as hide apps let you avoid data interference. Hide apps in different accounts for social media, games, or business apps—yes, hide apps work seamlessly here—and switch between them easily without logging in and out. This feature supports popular platforms like Facebook, Instagram, Snapchat, Telegram, and pairs with app lock for extra security. It also works with gaming apps such as Roblox, Call of Duty, Free Fire and MONOPOLY GO, where hide apps and app lock keep your accounts protected.",
